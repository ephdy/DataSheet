...
void OLED_Init(void)
{
  ...
  GPIO_Init(OLED_SDA_PORT, (GPIO_Pin_TypeDef)OLED_SDA_PINS, GPIO_Mode_Out_PP_High_Fast);
  GPIO_Init(OLED_RES_PORT, (GPIO_Pin_TypeDef)OLED_RES_PINS, GPIO_Mode_Out_PP_High_Fast);
  GPIO_Init(OLED_DC_PORT, (GPIO_Pin_TypeDef)OLED_DC_PINS, GPIO_Mode_Out_PP_High_Fast);
  GPIO_Init(OLED_CS_PORT, (GPIO_Pin_TypeDef)OLED_CS_PINS, GPIO_Mode_Out_PP_High_Fast);
